...
export class SSOConfigService {
  ...
  private config: SSOConfig = {
    ...
    showLoginGoogleButton: true,
    showSignUpFacebookButton: true,
    showSignUpGoogleButton: true,
    ...
    signUpAcceptOffersHtml: '<p class="text-sm text-left">Acepta para recibir actualizaciones sobre el mundo de la cerveza y obtén nuestras ofertas exclusivas! Sólo las enviamos a nuestros #BeerLovers (Te prometemos no enviar spam)</p>',
