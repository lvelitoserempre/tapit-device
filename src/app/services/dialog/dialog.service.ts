...
export class DialogService {
    ...
    openQRDialog(code: string): MatDialogRef<DialogComponent> {
        ...
        const dialogConfig: DialogConfigurationModel = {
            ...
            title: '¡Felicidades!',
            subtitle: 'Ya tienes tu código.',
            message: 'Hemos enviado tu código a tu correo para que puedas canjear tu Tap a Day.',
            qr: code,
            buttonOne: 'Aceptar'
        };
    ...
    openEventBookingSoldOutErrorDialog(): MatDialogRef<DialogComponent> {
        // TODO: translate
        const dialogConfig: DialogConfigurationModel = {
            title: 'No quedan plazas',
            message: 'El evento está lleno. Inténtalo de nuevo en otra ocasión.',
            buttonOne: 'Aceptar'
        };
    ...
    openEventBookingAlreadyGeneratedByUserErrorDialog(): MatDialogRef<DialogComponent> {
        ...
        const dialogConfig: DialogConfigurationModel = {
            ...
            message: 'Ya has generado el código.',
            buttonOne: 'Aceptar'
        };
