            ...
            <div className="section__prizes-container">
                <div>
                    <div className="col-xs-11 col-lg-10 col-lg-offset-2 middle-xs">
                        <h1 className="section__title section__title-small col-sm-7 col-lg-6 col-xl-4" dangerouslySetInnerHTML={{ __html: i18next.t("Section3.Title") }}></h1>
                        <div className="col-sm-8 col-lg-6 col-xl-5">
                    ...
                    <Plx className="row end-xs section__prizes-image relative" >
                        <div className="col-xs-12 col-sm-10 col-lg-8 col-xl-12">
