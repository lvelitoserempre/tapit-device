  ...
  function checkAge() {
    ...
    if (isValidDate(year, month - 1, day)) {
      if (age < 18) {
        ...
        setAdult(true);
        CookiesService.setValue('anonymousUserBirthDate', dateToLocal);
  ...
  return (
    <div id='agegate' className='agegate row center-sm middle-sm'>
      <div className='container center-xs row'>
        <div className='agegate__content col-xs-12 col-lg-7 center-xs middle-sm top-xs row'>
          <div>
            <p className="section__text">¡Hola!</p>
            <p className="section__text">Por favor ingresa tu fecha de nacimiento</p>
            <p className="section__text cookies-policies">Debes ser mayor de 18 años para acceder. Al ingresar, aceptas
              que utilizamos cookies para personalizar contenido y anuncios, proporcionar funciones de redes sociales y
              analizar nuestro tráfico. También compartimos información sobre cómo usted utiliza nuestro sitio con
              nuestros socios de redes sociales, de publicidad y de analítica.</p>
